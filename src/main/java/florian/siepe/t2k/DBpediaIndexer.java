...
public class DBpediaIndexer {
     ...
     *
     * @param index        the IIndex object representing location (or in memory index) to store index (must not be null)
     * @param rows         the records to be indexed (must not be null)
     * @param classIndices the class indices mapping table id to its name (must not be null)
     * @param sf           the surface forms (must not be null)
     */
